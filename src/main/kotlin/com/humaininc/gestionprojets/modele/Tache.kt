 ...
 * état de tâche. La [description] précise les détails de la réalisation de la tâche Le [createur] de la tâche est sauvegardé
 * et immuable. Chaque tâche possède une liste [Utilisateur] qui lui ont été affectés dans la liste [affectes]. La tâche
 * possède un [etat] qui indique sa progression et un niveau d'[importance].
 */
class Tache(id : Int?,
            var nom : String,
