 ...
 * @param actif indique si le projet est présentement actif
 *
 * @author Alexandre
 * @since 06/05/2023
 */
class Projet(
    id: Int?, nomProjet: String, dateDebut: LocalDate, dateFin: LocalDate,
    descriptionProjet: String, createur: Utilisateur, actif: Boolean
) : Entite(id) {
    ...
    /**
     * Indique si le projet est présentement actif
     */
